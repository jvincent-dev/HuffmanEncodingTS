...
exports.decodeForFunSharableText = exports.encodeForFunSharableText = void 0;
const HuffCode_1 = __importDefault(require("./classes/HuffCode"));
function encodeForFunSharableText(textToEncode) {
    const hc = new HuffCode_1.default();
...
exports.encodeForFunSharableText = encodeForFunSharableText;
function decodeForFunSharableText(textToDecode) {
    const hc = new HuffCode_1.default();
...
exports.decodeForFunSharableText = decodeForFunSharableText;
...
exports.default = HuffCode_1.default;
/** NOTES
